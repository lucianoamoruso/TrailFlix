...
public class AdminMainWindow extends MainWindow<AdminMain> {
  ...
  public static AdminMainWindow main(final String[] args) {
    AdminMainWindow _adminMainWindow = new AdminMainWindow();
    final Procedure1<AdminMainWindow> _function = new Procedure1<AdminMainWindow>() {
      public void apply(final AdminMainWindow it) {
        it.getModelObject().rellenarDatos();
        it.startApplication();
      }
    };
    return ObjectExtensions.<AdminMainWindow>operator_doubleArrow(_adminMainWindow, _function);
  }
}
