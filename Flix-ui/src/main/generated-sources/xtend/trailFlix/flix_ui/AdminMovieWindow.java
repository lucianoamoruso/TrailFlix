...
public class AdminMovieWindow extends TransactionalDialog<AdminMovie> {
  ...
  protected void createFormPanel(final Panel mainPanel) {
    ...
    Selector<Object> _selector = new Selector<Object>(panelDatos);
    ...
    ObjectExtensions.<Selector<Object>>operator_doubleArrow(_selector, _function_5);
      ...
      public void apply(final Button it) {
        ...
        final Action _function = new Action() {
          public void execute() {
            ...
            AdminMovie _modelObject = AdminMovieWindow.this.getModelObject();
            AdminContent _adminContent = new AdminContent(_trailFlix, _modelObject);
    ...
    List<Object> _list_1 = new List<Object>(panelRelated);
    final Procedure1<List<Object>> _function_14 = new Procedure1<List<Object>>() {
      public void apply(final List<Object> it) {
        it.allowNull(false);
        ObservableItems<Selector<Object>, Object, ListBuilder<Object>> _items = it.items();
        Binding _spaceship = ArenaXtendExtensions.operator_spaceship(_items, "relacionado");
        PropertyAdapter _propertyAdapter = new PropertyAdapter(Contenido.class, "titulo");
        _spaceship.setAdapter(_propertyAdapter);
        ObservableValue<Control, ControlBuilder> _value = it.<ControlBuilder>value();
        ArenaXtendExtensions.operator_spaceship(_value, "sel_relacionado");
      }
    };
    ObjectExtensions.<List<Object>>operator_doubleArrow(_list_1, _function_14);
